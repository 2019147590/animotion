{
  ...
  function conciseRuntimeText(debug = {}) {
    ...
    return compact([
      ...
      debug.effectivePrimaryPartId ? `effectivePrimaryPartId=${debug.effectivePrimaryPartId}` : null,
      debug.originalSelectedPartId ? `originalSelectedPartId=${debug.originalSelectedPartId}` : null,
      debug.segmentedLeadLocked ? "segmentedLeadLocked=true" : null,
