...
export type Part = {
  ...
  usage?: "leadWholeArmJabProxy" | "rearCrossHiddenFill" | string;
  ownerActionId?: string;
  createdForActionId?: string;
  createdFromJointActionId?: string;
  visibleForActionId?: string;
